...
The imputed value is the **30th percentile** of the participating servers' eRPS for that test, anchored at zero:

$$
\text{eRPS}_{\text{imputed}} = P_{30}\bigl(\{0\} \cup \{\text{eRPS}_{s',t} : s' \in \text{participants}\}\bigr)
$$
